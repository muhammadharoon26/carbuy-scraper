...
#     # Convert price to float, handling different currency representations
#     price = float(price_text.split()[1].replace(',', '')) if 'PKR' in price_text else float(price_text.split()[1].replace(',', ''))
...
#     # Convert price to float, handling different currency representations
#     price = float(price_text.split()[1].replace(',', '')) if 'PKR' in price_text else float(price_text.split()[1])
